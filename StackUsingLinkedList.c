...
To implement a Stack using a Linked List in C and perform basic stack operations such as push, pop, and display.

Algorithm (Stack Using Linked List)

We use a pointer top to represent the top of the stack.
...
If memory allocation fails, display “Stack Overflow” and exit.
...
If top == NULL, display “Stack Underflow” and exit.
