...
To create and implement a Doubly Linked List in C and perform basic operations such as insertion, deletion, and traversal.
...
Update last->prev->next = NULL

Free temp

Stop

5. Traversal (Display List)
